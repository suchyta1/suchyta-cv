...
%{\begin{itemize}[itemsep=3pt,parsep=0pt,topsep=3pt,partopsep=0pt]}
%{\end{itemize}}
...
maximizing the yield of rich datasets;
``big data'';
...
2015 - : & Postdoctoral Researcher \\ & Department of Physics \& Astronomy, University of Pennsylvania \tsp
...
2007 - 2010: & Undergraduate Research Associate, (Advisor: R. Sooryakumar) \\& Department of Physics, The Ohio State University \tsp
\end{tabularx}
...
%\section{Outreach}
%\begin{achievements}
%\item Scientific Thinkers volunteer teacher, Center for Emergent Materials, The Ohio State University.
%\item Girls Reaching to Achieve in Sports and Physics volunteer assistant, Society of Women in Physics, The Ohio State University.
%\item A day in the life... blog writer, Department of Physics, The Ohio Statue University.
%\end{achievements}
